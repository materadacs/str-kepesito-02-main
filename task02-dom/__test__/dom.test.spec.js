describe('Könyvlista felépítése', () => {
    ...
    test('Az összes könyv kilistázása csak eygszer zajlik le.', () => {
        const { listMyBooks } = require('../dom');
        const childresOfList = listMyBooks(bookList);
    ...
    test('A configStyle metódus megfelelően manipuálja a stílus jegyeket.', () => {
        const { configStyle } = require('../dom');
        configStyle();
